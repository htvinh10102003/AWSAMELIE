...
// Bảng màu cho trạng thái đơn hàng
const STATUS_COLORS = {
    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="w-full px-4 py-3 text-sm border border-white/30 rounded-2xl bg-white/60 backdrop-blur-xl hover:bg-white/80 focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all text-left flex items-center justify-between shadow-sm"
            >
                <span className={`${selected.length === 0 ? 'text-gray-400' : 'text-gray-700 font-medium'}`}>
                    {selected.length === 0 ? placeholder : `Đã chọn ${selected.length}`}
                </span>
            ...
            <div className="max-w-7xl mx-auto space-y-8 pb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div
                        ...
                        className={`cursor-pointer p-6 rounded-3xl border backdrop-blur-xl shadow-sm flex items-center gap-5 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg ${
                            activeTab === 'printable'
                                ? 'bg-green-100/60 border-green-300/50 shadow-green-100/30'
                                : 'bg-white/70 border-white/30 hover:border-green-200/30'
                        }`}
                    >
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${
                            activeTab === 'printable' ? 'bg-green-500/90 text-white shadow-lg shadow-green-500/20' : 'bg-green-100/80 text-green-600'
                        }`}>
                            <CheckCircle size={28} />
                        </div>
                        <div>
                    ...
                    <div
                        ...
                        className={`cursor-pointer p-6 rounded-3xl border backdrop-blur-xl shadow-sm flex items-center gap-5 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg ${
                            activeTab === 'holding'
                                ? 'bg-yellow-100/60 border-yellow-300/50 shadow-yellow-100/30'
                                : 'bg-white/70 border-white/30 hover:border-yellow-200/30'
                        }`}
                    >
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${
                            activeTab === 'holding' ? 'bg-yellow-500/90 text-white shadow-lg shadow-yellow-500/20' : 'bg-yellow-100/80 text-yellow-600'
                        }`}>
                    ...
                    <div
                        ...
                        className={`cursor-pointer p-6 rounded-3xl border backdrop-blur-xl shadow-sm flex items-center gap-5 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg ${
                            activeTab === 'outOfStock'
                                ? 'bg-red-100/60 border-red-300/50 shadow-red-100/30'
                                : 'bg-white/70 border-white/30 hover:border-red-200/30'
                        }`}
                    >
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${
                            activeTab === 'outOfStock' ? 'bg-red-500/90 text-white shadow-lg shadow-red-500/20' : 'bg-red-100/80 text-red-600'
                        }`}>
                            <XCircle size={28} />
                        </div>
                        <div>
                            ...
                            <div className="w-64">
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3 text-sm border border-white/30 rounded-2xl outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all bg-white/60 backdrop-blur-xl hover:bg-white/80 shadow-sm"
                                    />
                    ...
                    <div className="flex flex-wrap gap-4 items-end">
                        <div className="w-64">
                            <input
                                ...
                                className="w-full px-4 py-3 text-sm border border-white/30 rounded-2xl outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all bg-white/60 backdrop-blur-xl hover:bg-white/80 shadow-sm"
                            />
                        </div>
                        <div className="w-48">
                            <select
                                ...
                                className="w-full px-4 py-3 text-sm border border-white/30 rounded-2xl bg-white/60 backdrop-blur-xl hover:bg-white/80 focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all shadow-sm outline-none"
                            >
                                    ...
                                    {paginatedOrders.map(order => {
                                        ...
                                        return products.map((prod, index) => {
                                            ...
                                            return (
                                                <tr
                                                    key={`${order.id}-${index}`}
                                                    className={`${isChecked ? 'bg-blue-50/50 backdrop-blur-sm' : 'hover:bg-white/50'} transition-colors duration-200 font-medium`}
                                                >
                                                    {index === 0 && (
                                                        <>
                        ...
                        <div className="bg-white/50 backdrop-blur-md px-6 py-4 border-t border-white/30 flex flex-col sm:flex-row items-center justify-between text-sm font-medium text-gray-600 gap-4">
                            <div className="flex items-center gap-4 flex-wrap">
                                ...
                                <div className="flex items-center gap-2 border-l border-gray-200/50 pl-4">
                                    ...
                                    <select
                                        ...
                                        className="px-3 py-1.5 border border-white/30 bg-white/60 backdrop-blur-md rounded-xl font-medium text-gray-700 outline-none focus:ring-2 focus:ring-blue-400/20 transition shadow-sm"
                                    >
                            ...
                            <div className="flex items-center gap-1.5">
                                <button
                                    ...
                                    className="p-2.5 border border-white/30 bg-white/60 backdrop-blur-md rounded-xl hover:bg-white/80 disabled:opacity-40 disabled:cursor-not-allowed transition shadow-sm"
                                >
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`min-w-[2.5rem] h-10 rounded-xl border text-sm font-bold shadow-sm transition-all ${
                                                        currentPage === pageNum
                                                            ? 'bg-blue-600/90 backdrop-blur-md border-blue-600/30 text-white shadow-blue-500/20'
                                                            : 'bg-white/60 backdrop-blur-md hover:bg-white/80 text-gray-700 border-white/30'
                                                    }`}
                                                >
                                                    {pageNum}
                                                </button>
