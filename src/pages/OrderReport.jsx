    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl bg-gray-50 hover:bg-white focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all text-left flex items-center justify-between"
            >
            ...
            {isOpen && (
                <div className="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-xl shadow-2xl max-h-60 overflow-y-auto">
                    <label className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50 cursor-pointer border-b">
                        <input
                            type="checkbox"
                ...
                <div className="flex flex-wrap gap-4 items-end">
                    <div className="w-64">
                        <input
                            ...
                            className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all bg-gray-50 hover:bg-white"
                        />
                    </div>
                    <div className="w-48">
                        <select
                    ...
                    {/* <div className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            placeholder="Từ"
                            value={minAgingDays}
                            onChange={(e) => setMinAgingDays(e.target.value)}
                            className="w-20 px-3 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 hover:bg-white outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all"
                        />
                        ...
                        <input
                            ...
                            placeholder="Đến"
                            value={maxAgingDays}
                            onChange={(e) => setMaxAgingDays(e.target.value)}
                            className="w-20 px-3 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 hover:bg-white outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all"
                        />
                    </div> */}
                </div>
